	...
	<body>
		<div id="wrapper">
			...
			<div id="content_login">
				<form method="post" action="fb_login_process.php" name="register">
					<br>
					<table style="text-align: left; width: 250px; height: 153px; margin-left: auto; margin-right: auto;" border="1" cellpadding="2" cellspacing="2">
						<tbody>
							<tr>
								...
								<input maxlength="20" size="25" name="login_name" placeholder = "아이디" autofocus required type="email"><br><br>
								</td>
							</tr>
							<tr>
								<td style="vertical-align: top;">
